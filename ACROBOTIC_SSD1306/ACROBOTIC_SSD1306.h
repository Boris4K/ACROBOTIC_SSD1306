...
class ACROBOTIC_SSD1306 {
  public:
    ...
    void clearDisplay();
    void myClearDisplay();
    void myClearLine(unsigned char row);
    void setBrightness(unsigned char Brightness);
    bool putChar(unsigned char c);
    bool myPutChar(unsigned char c);
    void putString(const char *string);
    void myPutString(const char *string);
    void putString(String string);
    void myPutString(String string);
  ...
  private:
    ...
    uint8_t m_font_height;      // Font height
